...
Since the spread of the Novel Corona-virus across both Europe and North America, many have made comparisons between the United States and individual EU countries.  It is important to understand differences in population size between the United States and EU countries. Aggregating western European countries into a single entity is a more apt comparison to the United States when comparing data that is not adjusted for population.   
